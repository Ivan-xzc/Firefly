...
description: 雅思写作部分，根据Simon课程整理
...
First, make a very general comparison(**overview paragraph**)
...
The line graph(The graph below) compares(shows) the amount of electricity produced(electricity production) in France using four different sources of power over a period of 32 years (between 1980 and 2012).

### Overview 

描述两个总体趋势

It is clear that nuclear power was **by far the most important(highest)** means of electricity generation over the period shown. Renewables provided the lowest amount of electricity in each year.

### Details

起始点，转折点之前

In 1980，thermal power stations were the main source of electricity in France, generating around 120 terawatt hour of power. Nuclear and hydroelectric power stations produced just under 75 terawatt hours of electricity each, and renewables provided a **negligible(微忽其微的，可忽略的)** amount. Just one year later, nuclear poweer **overtook** thermal power as the **primary** source of electricity. 
...
by far the most important(highest) means

provided a **negligible(微忽其微的，可忽略的)** amount

**overtook** ... as the **primary** source of ...
...
**saw** only a small rise to **approximately** 

## 2.bar charts

Bar charts don't always shoe time..., they often only compare numbers

First, make a very general comparison (summary / overview paragraph)

Second, compare detailed numbers (details)

### Introduction 

The bar chart (the chart below) compares the number of mobile phones sold worldwide (global sales) by the five most popular manufacturers (of the top five mobile phones) in the years 2009, 2011, 2013 (between 2009 and 2013).

### Overview - 2 sentences, 2 main points

It is clear that Nokia sold the most mobile phones between 2009 and 2011, but Sambung became the best selling brand in 2013. Samsung and Apple saw the biggest rises in sales over the 5-year period.

### details - group together the items

In 2009, Nokia sold close to 450 million mobile phones, which was **almost double** the number of handsets sold by the **second most successful** manufacturer, Samsung. **Over the following four years**, however, Nokia's **sales figures fell by approximately 200 million units**, **whereas**2 Samsung **saw sales rise by a similar amount**. By 2013, Samsung **had become the market leader** with sales reaching 450 million units.

The other three top selling mobile phone brands between 2009 to 2013 were LG, ZTE and Apple. In 2009, these companies sold around 125 million, 50 million, and 25 million mobile handsets **respectively**, but Apple **overtook** the other two vendors in 2011. In 2013, purchases of Apple handsets reached 150 million units, **while** LG saw declining sales **and** the figures for ZTE rose only **slightly**.  
...
most popular, best selling brand, top seling

second most sucessful manufacturer

market leader 

mobiles phones, handsets, units

brands, manufactures, companies, vendors(公司)

saw the biggest rises, saw decline sales

close to, almost, approxiamately, around
...
The pie chart compare five categories of household expenditure in the UK and NewZealand in the years 1980 and 2008.

### Overview

It is notiveable that the proportion of spenging on food and drink fell in both countries over the 28-year period, while spending on utility bills rose. Also, UK residents spent a significant larger percentage of their household budgets on leisure than their New Zealand **counterparts**.

### Details

In 1980, 29% of an average New Zealand household budget went on food and drink, while the equivalent figure for a UK home was 23%. By 2008, expenditure on food and drink had fallen by 4% in New Zealand, and by a full 10% in the UK. By contrast, both countries saw an increase in expenditure on utility bills for the average home, from 27% to 31% in New Zealand and from 26% to 28% in th UK.

Leisure activities accounted for the highest proportion of Uk household spending in both years, but only the third highest proportion in New Zealand. in fact, in 2008, New Zealanders spent only half as much in relative terms on recreation as UK residents. in both countries, transport costa and other costs took roughly 15% and 10% of household budget respectively.
...
leisure acconuted for the highest proportion
...
The table compares the five highest ranking countries in terms of the numbersof visits and the money spent by tourists over a period of two years.
...
In 2012, 83 million tourists visited France, and the USA was the second most visited country, with 66.7 million tourists. Spain and China each received just under 58 million visitors,while Italy was ranked fifth with 46.4 million tourists. 2013 saw a rise of between 1 and 4 million tourist visits to each country, with the exception of China, which received 2 million fewer visitors than in the previous years.

Spending by tourists visiting the USA increased from $126.2 billion in 2012 to $139.6 billion in 2013, and these figures were well over twice as high as those for any other country. Spain received the second highest amounts of tourist revenue, rising from $56.3 billion to $60.4 billion, follewed by France, China and Italy. Interestingly, despite falling numbers of tourists, Chinese revenue from tourist rose by $1.7 billion in 2013.
...
these figures were well iver twice as high as
...
Second, describe specific numbers for each chart separately(details)
...
According to the bar chart, drama, painting and language courses all attracted more women than men to the education centre in 2009. Language classes had the highest number of participants overall, **with** 40 female and 20 male students, while painting was a popular choice among both genders, **attracting** 30 fenale and 25 male attendees. the only course with a higher number of males was sculpture, but this course was taken by a mere 15 people in total.
...
Lokking at the age profile pie chart,
...
At the firat stage in the production of class, sand, soda ash, liestone and other chemicals are mixed together. Next, this mixture is heated in a glass furnace at approxiamately 1500℃ to produce motlen glass. The molten glass can then be shaped, by blowing, to create the end products, namely glass containers. 
...
it require five steps

raw materials, end products

production, manufacturing

turned used glass into new products
...
describe the differences and the similarities
...
(one main thing changing, and one main thing not changing)

We can see that the new design proposal involves making a number of changes to the ground floor of the house, mainly at the central hall area. There are no plans to change extarnal walls or entrances.

### Details

The most noticeable change from the existing to the proposed floor plan is that there will no longer be a seperated hall area when the building work has been done. This will be achieved by removing the internal wall and door between the hall and living room, along with the current staircase and understair storage cupboard. With no seperate hall area, the proposed living room will also contain the staircase to the first floor.

To replace the current straight staircase, a new set of winding stairs will be installed in the corner of the living room. The internal door between the hall and kitchen will also be replaced with double doors, connecting the kitchen with the new living room. Finally, the plannned building work will also include the installation of some kitchen furniture.

### core words

existing plan -> current layout

proposed plan -> plan to design
